...
;
;====================================================================
;	- Colocar na tela do computador uma contagem de 1 at� 20.
;		Cada n�mero deve ser colocado em uma linha
;	- O contador, que dever� estar em mem�ria, deve ter largura 
;		de 16 bits e estar representado em bin�rio
;	- O contador dever� ser convertido de bin�rio para ASCII de 
;		maneira a ser colocado na tela
;	- Usar as fun��es HexToDecAscii e a WriteString
;====================================================================
;
		.model small
		.stack
...
Again:
		mov		ax,Contador		; Apresenta o conte�do de Contador na tela
		call	WriteWord
